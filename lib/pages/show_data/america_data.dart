...
class AmericaData extends StatefulWidget {
  @override
  _AmericaDataState createState() => _AmericaDataState();
}

class _AmericaDataState extends State<AmericaData> {
  DB database = DB.db;
  int count = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const GlobalAppBar(title: 'America'),
      body: FutureBuilder(
          future: database.getAllData(americaDbTable),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                database.deleteData(
                                    this.notesList[index].id, americaDbTable);
                                updateListView();
                              },
  ...
  updateListView() {
    ...
    futureDb.then((value) {
      Future<List<DayRead>> noteListFuture =
          database.getAllData(americaDbTable);
