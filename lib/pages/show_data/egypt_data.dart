...
import 'package:coronavirus/pages/edit_data.dart';
...
class EgyptData extends StatefulWidget {
  @override
  _EgyptDataState createState() => _EgyptDataState();
}

class _EgyptDataState extends State<EgyptData> {
  DB database = DB.db;
  int count = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const GlobalAppBar(title: 'Egypt'),
      body: FutureBuilder(
          future: database.getAllData(egyptDbTable),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                database.deleteData(
                                    this.notesList[index].id, egyptDbTable);
                                updateListView();
                              },
  ...
  updateListView() {
    ...
    futureDb.then((value) {
      Future<List<DayRead>> noteListFuture = database.getAllData(egyptDbTable);
